...
/**
 * Utils - MysqlDbInstall
 * 
 * @author APP TEAM
 * @version 1.0
 */
public class MysqlDbInstall {
	...
	public static String databaseType = "mysql";// mysql, sqlserver, oracle
	...
	public static String databaseName = "appAdmin0";// 【修改】
	public static String adminUsername = "admin";// 【可修改】
	public static String adminPassword = "123456";// 【可修改】
	public static String contextPath = "localhost/";// 【可修改】
