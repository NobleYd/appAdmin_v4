									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<div class="checkbox">
																<label>
														            <input id="isCurrent" name="isCurrent" value="true" checked="checked" class="ace ace-switch ace-switch-2" type="checkbox" />
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<div class="checkbox">
																<label>
														            <input id="isCurrent" name="isDebug" value="true" checked="checked" class="ace ace-switch ace-switch-2" type="checkbox" />
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input type="text" id="commonTemplatePath" name="commonTemplatePath" class="col-xs-10 col-sm-5" />
													    </div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input type="text" id="customerTemplatePath" name="customerTemplatePath" class="col-xs-10 col-sm-5" />
													    </div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input type="text" id="javaOutputPath" name="javaOutputPath" class="col-xs-10 col-sm-5" />
													    </div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input type="text" id="pageOutputPath" name="pageOutputPath" class="col-xs-10 col-sm-5" />
													    </div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input type="text" id="table_prefix_defaule" name="table_prefix_defaule" class="col-xs-10 col-sm-5" />
													    </div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input type="text" id="request_mapping_prefix_defaule" name="request_mapping_prefix_defaule" class="col-xs-10 col-sm-5" />
													    </div>
													</div>
												</div>
