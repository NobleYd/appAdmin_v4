...
<html lang="en">
	...
	<body class="no-skin">
						...
						<form id="listForm" action="list.jhtml" method="get">
							...
							<div class="page-header">
								...
								<div class="btn-group">
								    ...
								    <ul id="add2project" class="dropdown-menu dropdown-success">
								        [#list devProjects as devProject]
								        <li name="devProjectId" val="${(devProject.id)!}" >
											<a href="javascript:void(0);" >${(devProject.name)!'-'}</a>
										</li>
									...
									<table id="listTable" class="list table table-bordered table-hover">
										...
										[#list page.content as devEntity]
											<tr>
												...
												<td>
													<span name="entityType">${(devEntity.entityType.label)!}</span>
												</td>
												<td>
		...
		$().ready(function() {
			...
			//add2project
			var $add2project = $("#add2project li");
			...
			$add2project.click( function() {
				...
				var $params = $checkedIds.serialize() + "&devProjectId=" + $this.attr("val");
				$.dialog({
					type: "warn",
					content: "您确定执行该操作么？",
					ok: message("admin.dialog.ok"),
