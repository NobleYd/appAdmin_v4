...
public enum ResultType {
	...
	// get_yao_user_info_failure (9001004,"获取摇周边用户信息失败"),
	// get_info_failure(9001005,"获取商户信息失败"),
	// a(9001006,"获取OpenID失败"),
	// a(9001007,"上传文件缺失"),
	// a(9001008,"上传素材的文件类型不合法"),
	// a(9001009,"上传素材的文件尺寸不合法"),
	// a(9001010,"上传失败"),
	// a(9001020,"帐号不合法"),
	// a(9001021,"已有设备激活率低于50%，不能新增设备"),
	// a(9001022,"设备申请数不合法，必须为大于0的数字"),
	// a(9001023,"已存在审核中的设备ID申请"),
	// a(9001024,"一次查询设备ID数量不能超过50"),
	// a(9001025,"设备ID不合法"),
	// a(9001026,"页面ID不合法"),
	// a(9001027,"页面参数不合法"),
	// a(9001028,"一次删除页面ID数量不能超过10"),
	// a(9001029,"页面已应用在设备中，请先解除应用关系再删除"),
	// a(9001030,"一次查询页面ID数量不能超过50"),
	// a(9001031,"时间区间不合法"),
	// a(9001032,"保存设备与页面的绑定关系参数错误"),
	// a(9001033,"门店ID不合法"),
	// a(9001034,"设备备注信息过长"),
	// a(9001035,"设备申请参数不合法"),
	// a(9001036,"查询起始值begin不合法");
