...
public class OssController extends BaseController {
	...
	public String setting(ModelMap model) {
		...
		return "/com/app/plugin/view/oss/setting";
	}
	...
	public String update(String accessId, String accessKey, String bucketName, String endPoint, String urlPrefix, @RequestParam(defaultValue = "false") Boolean isEnabled, Integer order, RedirectAttributes redirectAttributes) {
		PluginConfig pluginConfig = ossPlugin.getPluginConfig();
		...
		pluginConfig.setAttribute("endPoint", StringUtils.removeEnd(endPoint, "/"));
