...
<html lang="en">
	<head>
		...
		<title>${message("admin.plugin.ftp.setting")} - Powered By APP TEAM</title>
	</head>
	<body class="no-skin">
				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" >
						...
						<ul class="breadcrumb">
							...
							<li class="active">
								<span>${message("admin.plugin.ftp.setting")}</span>
							</li>
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="host">
														<span class="text-danger">*</span>
														${message("admin.plugin.ftp.host")}:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input type="text" id="host" name="host" value="${pluginConfig.attributes['host']}" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="port">
														<span class="text-danger">*</span>
														${message("admin.plugin.ftp.port")}:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input type="text" id="port" name="port" value="${pluginConfig.attributes['port']}" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="username">
														<span class="text-danger">*</span>
														${message("admin.plugin.ftp.username")}:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input type="text" id="username" name="username" value="${pluginConfig.attributes['username']}" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input type="password" id="password" name="password" value="${pluginConfig.attributes['password']}" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="urlPrefix">
														<span class="text-danger">*</span>
														${message("admin.plugin.ftp.urlPrefix")}:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
