...
<html lang="en">
	<head>
		...
		<title>编辑联系人 - Powered By APP TEAM</title>
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="name" value="${(contact.name)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<select name="sex" class="col-xs-10 col-sm-5" >
																...
																[#list Sexs as Sex]
																<option value="${Sex}" [#if (contact.sex)! == Sex]selected="selected"[/#if] >${(Sex.label)!'-'}</option>
																[/#list]
															</select>	
														</div>
													</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="mobile" value="${(contact.mobile)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="email" value="${(contact.email)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="remark" value="${(contact.remark)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
			...
			$inputForm.validate({
				rules: {
					name: {
						required: true,
						remote: {
							url: "check_name_unique.jhtml?previousName=${contact.name?url}",
							cache: false
						},
					},
					sex: {
