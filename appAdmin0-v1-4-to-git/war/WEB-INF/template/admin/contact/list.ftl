...
<html lang="en">
	<head>
		...
		<title>联系人列表 - Powered By APP TEAM</title>
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			[#assign menu="contactGroup" subMenu="contact" ]
									...
									<div class="btn-group">
									    ...
									    <ul id="searchPropertyOption" class="dropdown-menu dropdown-info">
											...
											<li [#if page.searchProperty == "name" ] class="active" [/#if] val="name" >
												<a href="javascript:;" >姓名/昵称</a>
											</li>
											<!-- 根据N-1类型的titleAttribute搜索 -->
											<!-- 根据N-1类型的titleAttribute搜索 -->
											<li [#if page.searchProperty == "mobile" ] class="active" [/#if] val="mobile" >
												<a href="javascript:;" >联系电话</a>
											</li>
											<!-- 根据N-1类型的titleAttribute搜索 -->
											<li [#if page.searchProperty == "email" ] class="active" [/#if] val="email" >
												<a href="javascript:;" >电子邮箱</a>
											</li>
											<!-- 根据N-1类型的titleAttribute搜索 -->
											<li [#if page.searchProperty == "remark" ] class="active" [/#if] val="remark" >
									...
									<table id="listTable" class="list table table-bordered table-hover">
										<thead>
											<tr>
												...
												<th>
													<a href="javascript:;" class="sort" name="mobile">
														联系电话
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
										...
										[#list page.content as contact ]
											<tr>
												<td class="center">
													<label class="pos-rel">
														<input type="checkbox" name="ids" class="ace" value="${contact.id}" />
														<span class="lbl"></span>
													</label>
												</td>
												<td>				
												...
												<td>
													<span name="sex">${(contact.sex.label)!}</span>
												</td>
												<td>				
													<span name="mobile">${(contact.mobile)!}</span>
												</td>
												<td>				
													<span name="email">${(contact.email)!}</span>
												</td>
												<td>				
													<span name="remark">${(contact.remark)!}</span>
												</td>
												<td>
													<!-- 大型ui -->
													<div class="hidden-sm hidden-xs btn-group">
														<a class="btn btn-xs btn-info" href="edit.jhtml?id=${contact.id}" >
															<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
															<span>${message("admin.common.edit")}</span>
														</a>
														<a href="javascript:void(0);" class="deleteButton btn btn-xs btn-danger" ids="${contact.id}" >
															<i class="ace-icon fa fa-trash-o bigger-120"></i>
															<span>${message("admin.common.delete")}</span>
														</a>
														<a class="btn btn-xs btn-success" href="to_mail_send.jhtml?id=${contact.id}" >
													...
													<div class="hidden-md hidden-lg">
														<div class="inline pos-rel">
															...
															<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																<li>
																	<a href="edit.jhtml?id=${contact.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
																		<span class="blue">
																			<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
																			<span>${message("admin.common.edit")}</span>
																		</span>
																...
																<li>
																	<a href="javascript:void(0);" class="deleteButton tooltip-error" ids="${contact.id}" data-rel="tooltip" title="Delete">
																		<span class="red">
																			<i class="ace-icon fa fa-trash-o bigger-120"></i>
																			<span>${message("admin.common.delete")}</span>
																		</span>
																...
																<li>
																	<a href="to_mail_send.jhtml?id=${contact.id}" class="tooltip-success" data-rel="tooltip" title="Send email">
																		<span class="green">
																			<i class="ace-icon fa fa-location-arrow bigger-120"></i>
																			<span>邮件</span>
																		</span>
