					...
					<ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
						...
						<li class="dropdown-content">
							<ul class="dropdown-menu dropdown-navbar">
								...
								<li>
									<a href="#" class="clearfix">
										<img src="${base}/resources/assets/avatars/avatar2.png" class="msg-photo" alt="Kate's Avatar" />
										<span class="msg-body">
											<span class="msg-title">
								...
								<li>
									<a href="#" class="clearfix">
										<img src="${base}/resources/assets/avatars/avatar5.png" class="msg-photo" alt="Fred's Avatar" />
										<span class="msg-body">
											<span class="msg-title">
					...
					<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
						<li>
							<a href="${base}/admin/setting/edit.jhtml">
								...
								${message("admin.main.setting")}
							</a>
						</li>
						<li>
							<a href="${base}/admin/profile/edit.jhtml">
								<i class="ace-icon fa fa-user"></i>
								<span>${message("admin.main.profile")}</span>
							</a>
						</li>
						<li class="divider"></li>
						<li>
							<a href="${base}/admin/logout.jhtml">
								<i class="ace-icon fa fa-power-off"></i>
								<span>${message("admin.main.logout")}</span>
							</a>
						</li>
					</ul>
				</li>
