...
<html lang="en">
	<head>
		...
		<title>生成二维码 - Powered By APP TEAM</title>
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			[#assign menu="toolGroup" subMenu="qrcode" ]
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input id="content" name="content" value="http://www.baidu.com" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
												...
												<div class="clearfix form-actions">
												    <div class="col-sm-offset-3 col-sm-9">
												    	<span class="input-icon">
													        ...
													        <input id="btnOk" type="button" class="btn btn-info btn-sm" value="生成" />
														</span>
												    </div>
												</div>
									        </div><!-- end of base -->
		...
		<script src="${base}/resources/admin/js/jquery.qrcode.min.js"></script>
