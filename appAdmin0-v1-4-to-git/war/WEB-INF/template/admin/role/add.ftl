				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" >
						...
						<ul class="breadcrumb">
							...
							<li class="active">
								<span>${message("admin.role.add")}</span>
							</li>
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<div class="checkbox pull-left">
																<label>
														            <input name="authorities" value="admin:setting" class="ace" type="checkbox">
														            <span class="lbl">&nbsp; ${message("admin.role.setting")}</span>
																</label>
														    </div>
														    <div class="checkbox pull-left">
																<label>
														            <input name="authorities" value="admin:storagePlugin" class="ace" type="checkbox">
														            <span class="lbl">&nbsp; ${message("admin.role.storagePlugin")}</span>
																</label>
														    </div>
														    <div class="checkbox pull-left">
																<label>
														            <input name="authorities" value="admin:admin" class="ace" type="checkbox">
														            <span class="lbl">&nbsp; ${message("admin.role.admin")}</span>
																</label>
														    </div>
														    <div class="checkbox pull-left">
																<label>
														            <input name="authorities" value="admin:role" class="ace" type="checkbox">
														            <span class="lbl">&nbsp; ${message("admin.role.role")}</span>
																</label>
														    </div>
														    <div class="checkbox pull-left">
																<label>
														            <input name="authorities" value="admin:cache" class="ace" type="checkbox">
