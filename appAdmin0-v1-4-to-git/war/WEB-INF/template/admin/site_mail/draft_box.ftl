...
<html lang="en">
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			[#assign menu="siteMailGroup" subMenu="draftBox" ]
			...
			<div class="main-content">
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<!-- 列表表单开始 -->
						<form id="listForm" action="draft_box.jhtml" method="get">
											...
											<tr class="[#if siteMail.isRead?? && siteMail.isRead]success[#else]info[/#if]" >
												...
												<td>
													...
													<div class="hidden-sm hidden-xs btn-group">
														<a class="btn btn-xs btn-info" href="to_mail_send.jhtml?draftId=${siteMail.id}" >
													...
													<div class="hidden-md hidden-lg">
														<div class="inline pos-rel">
															...
															<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																<li>
																	<a href="to_mail_send.jhtml?draftId=${siteMail.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
																		<span class="blue">
																			<i class="ace-icon fa fa-location-arrow bigger-120"></i>
																			<span>继续发送</span>
																		</span>
