									...
									<table id="listTable" class="list table table-bordered table-hover">
										<thead>
											<tr>
												...
												<th>
													<span name="toContact">收件人</span>
												</th>
												<th>
													<span name="location">位置</span>
												</th>
												<th>
										...
										[#list page.content as siteMail ]
											<tr class="[#if siteMail.isRead?? && siteMail.isRead]success[#else]info[/#if]">
												...
												<td>	
													<span name="authorAdmin">${(siteMail.authorAdmin.name)!}</span>
												</td>
												<td>	
													<span name="toAdmin">${(siteMail.toAdmin.name)!}</span>
												</td>
												<td>	
													<span name="toContact">${(siteMail.toContact.name)!}</span>
												</td>
												<td>
													<span name="location">${(siteMail.authorLocation.label)!} --> ${(siteMail.toLocation.label)!}</span>
												</td>
												<td>
												...
												<td>
													...
													<div class="hidden-sm hidden-xs btn-group">
														<a class="btn btn-xs btn-info" href="edit.jhtml?id=${siteMail.id}" >
													...
													<div class="hidden-md hidden-lg">
														<div class="inline pos-rel">
															...
															<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																<li>
																	<a href="edit.jhtml?id=${siteMail.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
																		<span class="blue">
																			<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
																			<span>${message("admin.common.edit")}</span>
																		</span>
