...
<html lang="en">
	<head>
		...
		<title>邮件列表 - Powered By APP TEAM</title>
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			[#assign menu="siteMailGroup" subMenu="receivedBox" ]
			...
			<div class="main-content">
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<!-- 列表表单开始 -->
						<form id="listForm" action="received_box.jhtml" method="get">
								...
								<div class="btn-group btn-corner pull-right">
									<div class="btn-group">
									    ...
									    <ul id="searchPropertyOption" class="dropdown-menu dropdown-info">
											...
											<li [#if page.searchProperty == "authorAdmin.username" ] class="active" [/#if] val="authorAdmin.username" >
												<a href="javascript:;" >发件人</a>
											</li>
											<li [#if page.searchProperty == "authorAdmin.name" ] class="active" [/#if] val="authorAdmin.name" >
												<a href="javascript:;" >发件人姓名</a>
											</li>
									    </ul>
									</div>
									...
									<table id="listTable" class="list table table-bordered table-hover">
										<thead>
											<tr>
												...
												<th>
													<a href="javascript:;" class="sort" name="authorAdmin">
														发件人
										...
										<tbody>
										[#list page.content as siteMail ]
											<tr  class="[#if siteMail.isRead?? && siteMail.isRead]success[#else]info[/#if]" >
												<td class="center">
													<label class="pos-rel">
														<input type="checkbox" name="ids" class="ace" value="${siteMail.id}" />
														<span class="lbl"></span>
													</label>
												</td>
												<td>	
													<span name="authorAdmin">
														${(siteMail.authorAdmin.username)!}[#if siteMail.authorAdmin.name?? ]-${(siteMail.authorAdmin.name)!}[/#if]
													</span>
												</td>
												<td>				
													<span name="title">${(siteMail.title)!}</span>
												</td>
												<td>
													[#if siteMail.isRead?? && siteMail.isRead]
														<span name="isRead"" val="false" class="trueIcon">&nbsp;</span>
													[#else]
														<span name="isRead"" val="true" class="falseIcon">&nbsp;</span>
													[/#if]
												</td>
												<td>	
													<span name="createDate">${(siteMail.createDate?string("yyyy-MM-dd HH:mm:ss"))!}</span>
												</td>
												<td>
													<!-- 大型ui -->
													<div class="hidden-sm hidden-xs btn-group">
														<a class="btn btn-xs btn-info" href="view.jhtml?id=${siteMail.id}" >
															<i class="ace-icon fa fa-eye bigger-120"></i>
															<span>${message("admin.common.view")}</span>
														</a>
														<a href="javascript:void(0);" class="deleteButton btn btn-xs btn-danger" ids="${siteMail.id}" >
													...
													<div class="hidden-md hidden-lg">
														<div class="inline pos-rel">
															...
															<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																<li>
																	<a href="view.jhtml?id=${siteMail.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
																		<span class="blue">
																			<i class="ace-icon fa fa-eye bigger-120"></i>
																			<span>${message("admin.common.view")}</span>
																		</span>
																...
																<li>
																	<a href="javascript:void(0);" class="deleteButton tooltip-error" ids="${siteMail.id}" data-rel="tooltip" title="Delete">
																		<span class="red">
																			<i class="ace-icon fa fa-trash-o bigger-120"></i>
																			<span>${message("admin.common.delete")}</span>
																		</span>
