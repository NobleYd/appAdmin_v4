...
<html lang="en">
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			[#assign menu="siteMailGroup" subMenu="sentBox" ]
			...
			<div class="main-content">
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<!-- 列表表单开始 -->
						<form id="listForm" action="sent_box.jhtml" method="get">
								...
								<div class="btn-group btn-corner pull-right">
									<div class="btn-group">
									    ...
									    <ul id="searchPropertyOption" class="dropdown-menu dropdown-info">
											...
											<li [#if page.searchProperty == "toAdmin.username" ] class="active" [/#if] val="toAdmin.username" >
												<a href="javascript:;" >收件人</a>
											</li>
											<li [#if page.searchProperty == "toAdmin.name" ] class="active" [/#if] val="toAdmin.name" >
												<a href="javascript:;" >收件人姓名</a>
											</li>
									    </ul>
									</div>
									...
									<table id="listTable" class="list table table-bordered table-hover">
										<thead>
											<tr>
												...
												<th>
													<a href="javascript:;" class="sort" name="toAdmin">
														收件人
										...
										[#list page.content as siteMail ]
											<tr class="[#if siteMail.isRead?? && siteMail.isRead]success[#else]info[/#if]" >
												...
												<td>
													[#if (siteMail.toAdmin??)]
													<span name="toAdmin">
														${(siteMail.toAdmin.username)!}[#if siteMail.toAdmin.name?? ]-${(siteMail.toAdmin.name)!}[/#if]
													</span>
													[#else]
													<span name="toContact">${(siteMail.toContact.name)!}</span>
													[/#if]
												</td>
												<td>				
