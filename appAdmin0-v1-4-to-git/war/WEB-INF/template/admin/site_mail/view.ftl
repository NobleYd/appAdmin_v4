			...
			<div class="main-content">
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<!-- 表单开始 -->
						<form id="inputForm" action=".jhtml" class="form-horizontal" role="form" method="post"  >
								...
								<div class="col-xs-12">
									<div class="tabbable">
									    <ul class="nav nav-tabs padding-12 tab-color-blue background-blue">
									        <li class="active">
									            <a aria-expanded="true" data-toggle="tab" href="#base">邮件查看</a>
									        </li>
									    </ul>
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												<div class="form-group">
													<label class="col-sm-12 no-padding-right" >
														<span>${(siteMail.authorAdmin.username)!}[#if (siteMail.authorAdmin.name??)](${(siteMail.authorAdmin.name)!})[/#if]</span>
														&nbsp;
														To
														&nbsp;
														[#if siteMail.toAdmin?? ]
														<span>${(siteMail.toAdmin.username)!}[#if (siteMail.toAdmin.name??)](${(siteMail.toAdmin.name)!})[/#if]</span>
														[#elseif siteMail.toContact?? ]
														<span>${(siteMail.toContact.name)!}</span>
														[/#if]
													</label>
												</div>
												<div class="form-group">
													<label class="col-sm-12 no-padding-right" >
														<span>标题：${(siteMail.title)!}</span>
													</label>
												</div>
												<div class="form-group">
													<label class="col-sm-12 no-padding-right">
