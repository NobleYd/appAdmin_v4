...
<html lang="en">
	<head>
		...
		<title>编辑模板 - Powered By APP TEAM</title>
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="name" value="${(template.name)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<select name="type" class="col-xs-10 col-sm-5" >
																[#list Types as Type]
																<option value="${Type}" [#if (template.type)! == Type]selected="selected"[/#if] >${(Type.label)!'-'}</option>
																[/#list]
															</select>	
														</div>
													</div>
												...
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="staticPath">
														<span>静态化路径</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="staticPath" value="${(template.staticPath)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="description" value="${(template.description)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<textarea id="editor" name="content" class="editor">${(template.content)!}</textarea>
														</div>
													</div>
												</div>
			...
			$inputForm.validate({
				rules: {
					name: {
						required: true,
						remote: {
							url: "check_name_unique.jhtml?previousName=${template.name?url}",
							cache: false
						},
					},
					type: {
