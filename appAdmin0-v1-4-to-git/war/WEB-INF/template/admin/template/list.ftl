...
<html lang="en">
	<head>
		...
		<title>模板列表 - Powered By APP TEAM</title>
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			[#assign menu="templateGroup" subMenu="template" ]
									...
									<div class="btn-group">
									    ...
									    <ul id="searchPropertyOption" class="dropdown-menu dropdown-info">
											...
											<li [#if page.searchProperty == "name" ] class="active" [/#if] val="name" >
												<a href="javascript:;" >模板名称</a>
											</li>
											<!-- 根据N-1类型的titleAttribute搜索 -->
											<!-- 根据N-1类型的titleAttribute搜索 -->
											<li [#if page.searchProperty == "templatePath" ] class="active" [/#if] val="templatePath" >
												<a href="javascript:;" >模板路径</a>
											</li>
											<!-- 根据N-1类型的titleAttribute搜索 -->
											<li [#if page.searchProperty == "staticPath" ] class="active" [/#if] val="staticPath" >
												<a href="javascript:;" >静态化路径</a>
											</li>
											<!-- 根据N-1类型的titleAttribute搜索 -->
											<li [#if page.searchProperty == "description" ] class="active" [/#if] val="description" >
												<a href="javascript:;" >模板描述</a>
											</li>
									    </ul>
									</div>
									...
									<table id="listTable" class="list table table-bordered table-hover">
										<thead>
											<tr>
												...
												<th>
													<a href="javascript:;" class="sort" name="templatePath">
														模板路径
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
												<th>
													<a href="javascript:;" class="sort" name="staticPath">
														静态化路径
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
										...
										[#list page.content as template ]
											<tr>
												<td class="center">
													<label class="pos-rel">
														<input type="checkbox" name="ids" class="ace" value="${template.id}" />
														<span class="lbl"></span>
													</label>
												</td>
												<td>				
													<span name="name">${(template.name)!}</span>
												</td>
												<td>
													<span name="type">${(template.type.label)!}</span>
												</td>
												<td>				
													<span name="templatePath">${(template.templatePath)!}</span>
												</td>
												<td>				
													<span name="staticPath">${(template.staticPath)!}</span>
												</td>
												<td>				
													<span name="description">${(template.description)!}</span>
												</td>
												<td>
													<!-- 大型ui -->
													<div class="hidden-sm hidden-xs btn-group">
														<a class="btn btn-xs btn-info" href="edit.jhtml?id=${template.id}" >
															<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
															<span>${message("admin.common.edit")}</span>
														</a>
														<a href="javascript:void(0);" class="deleteButton btn btn-xs btn-danger" ids="${template.id}" >
													...
													<div class="hidden-md hidden-lg">
														<div class="inline pos-rel">
															...
															<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																<li>
																	<a href="edit.jhtml?id=5" class="tooltip-success" data-rel="tooltip" title="Edit">
																		<span class="blue">
																			<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
																			<span>${message("admin.common.edit")}</span>
																		</span>
																...
																<li>
																	<a href="javascript:void(0);" class="deleteButton tooltip-error" ids="${template.id}" data-rel="tooltip" title="Delete">
																		<span class="red">
																			<i class="ace-icon fa fa-trash-o bigger-120"></i>
																			<span>${message("admin.common.delete")}</span>
																		</span>
