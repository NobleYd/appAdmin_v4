...
<html lang="en">
	<head>
		...
		<title>编辑普通实体演示 - Powered By APP TEAM</title>
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<form id="inputForm" action="update.jhtml" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" >
							<!-- 实体ID隐藏域 -->
							<input type="hidden" name="id" value="${normalEntity.id}" />
							<div class="row">
								<div class="col-xs-12">
									<div class="tabbable">
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="name" value="${(normalEntity.name)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<select name="sex" class="col-xs-10 col-sm-5" >
																[#list Sexs as Sex]
																<option value="${Sex}" [#if (normalEntity.sex)! == Sex]selected="selected"[/#if] >${(Sex.label)!'-'}</option>
																[/#list]
															</select>
														</div>
													</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="age" value="${(normalEntity.age)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input type="text" id="birthDate" name="birthDate" value="${(normalEntity.birthDate)!}" class="Wdate col-xs-10 col-sm-5" onfocus="WdatePicker()" maxlength="100" />			
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">	
															<div class="checkbox">
																<label>
															        <input id="headlthState" name="headlthState" value="true" [#if (normalEntity.headlthState)!]checked="checked"[/#if] class="ace ace-switch ace-switch-2" type="checkbox" />
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															...
															&nbsp;&nbsp;
															<label class="selectedLabel control-label" [#if !(normalEntity.lover??) ]style="display:none;"[/#if] >
																<span class="red" >当前选择：</span>
																<span class="value" >${(normalEntity.lover.name)!}</span>
															</label>
															&nbsp;&nbsp;
															<input type="hidden" style="width:50px!important;" id="loverId" name="loverId" value="${(normalEntity.lover.id)!}" title="请填写关联实体的 【ID】属性" class="col-xs-5 col-sm-2" />
															<a href="javascript:void(0);" style="width:50px!important; [#if !(normalEntity.lover??) ]display:none;[/#if]" class="clearInputs btn btn-info btn-xs" >清空</a>
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														...
														<a href="${(normalEntity.picture)!}" class="btn btn-info btn-xs" target="_blank">${message("admin.common.view")}</a>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="score" value="${(normalEntity.score)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														...
														<a href="${(normalEntity.attachment)!}" class="btn btn-info btn-xs" target="_blank">${message("admin.common.view")}</a>
													</div>
												</div>
			...
			$inputForm.validate({
				rules: {
					name: {
						required: true,
						remote: {
							url: "check_name_unique.jhtml?previousName=${normalEntity.name?url}",
							cache: false
						},
					},
					sex: {
