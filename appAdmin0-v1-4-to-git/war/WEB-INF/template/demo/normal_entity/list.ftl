...
<html lang="en">
	<head>
		...
		<title>普通实体演示列表 - Powered By APP TEAM</title>
						...
						<form id="listForm" action="list.jhtml" method="get">
							...
							<div class="page-header">
								...
								<span class="input-icon">
									...
									<input type="submit" class="btn btn-info btn-xs" name="export" value="导出报表" />
							    </span>
									...
									<table id="listTable" class="list table table-bordered table-hover">
										<thead>
											<tr>
												...
												<th>
													<a href="javascript:;" class="sort" name="age">
														年龄
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
												<th>
													<a href="javascript:;" class="sort" name="birthDate">
												...
												<th>
													<a href="javascript:;" class="sort" name="headlthState">
														健康状况
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
												<th>
													<span name="lover">爱人</span>
												</th>
												<th>
													<span name="picture">照片</span>
												</th>
												<th>
													<a href="javascript:;" class="sort" name="score">
														综合评分[满分100]
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
												<th>
													<span name="attachment">附件</span>
												</th>
												<th>
										...
										<tbody>
										[#list page.content as normalEntity ]
											<tr>
												<td class="center">
													<label class="pos-rel">
														<input type="checkbox" name="ids" class="ace" value="${normalEntity.id}" />
														<span class="lbl"></span>
													</label>
												</td>
												<td>				
													<span name="name">${(normalEntity.name)!}</span>
												</td>
												<td>
													<span name="sex">${(normalEntity.sex.label)!}</span>
												</td>
												<td>				
													<span name="age">${(normalEntity.age)!}</span>
												</td>
												<td>
													<span name="birthDate">${(normalEntity.birthDate?string("yyyy-MM-dd HH:mm:ss"))!}</span>
												</td>
												<td>
													[#if normalEntity.headlthState?? && normalEntity.headlthState]
														<span name="headlthState"" val="false" class="trueIcon">&nbsp;</span>
													[#else]
														<span name="headlthState"" val="true" class="falseIcon">&nbsp;</span>
													[/#if]
												</td>
												<td>	
													<span name="lover">${(normalEntity.lover.name)!}</span>
												</td>
												<td>
													[#if normalEntity?? && normalEntity.picture??]
													<a title="picture" href="${(normalEntity.picture)!}" target="_blank" >查看/下载</a>	
													[/#if]
												</td>
												<td>				
													<span name="score">${(normalEntity.score)!}</span>
												</td>
												<td>
													<a title="attachment" href="${(normalEntity.attachment)!}" target="_blank" >查看/下载</a>	
												</td>
												<td>
													<!-- 大型ui -->
													<div class="hidden-sm hidden-xs btn-group">
														<a class="btn btn-xs btn-info" href="edit.jhtml?id=${normalEntity.id}" >
															<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
															<span>${message("admin.common.edit")}</span>
														</a>
														<a href="javascript:void(0);" class="deleteButton btn btn-xs btn-danger" ids="${normalEntity.id}" >
													...
													<div class="hidden-md hidden-lg">
														<div class="inline pos-rel">
															...
															<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																<li>
																	<a href="edit.jhtml?id=4" class="tooltip-success" data-rel="tooltip" title="Edit">
																		<span class="blue">
																			<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
																			<span>${message("admin.common.edit")}</span>
																		</span>
																...
																<li>
																	<a href="javascript:void(0);" class="deleteButton tooltip-error" ids="${normalEntity.id}" data-rel="tooltip" title="Delete">
																		<span class="red">
																			<i class="ace-icon fa fa-trash-o bigger-120"></i>
																			<span>${message("admin.common.delete")}</span>
																		</span>
