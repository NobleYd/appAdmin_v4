...
<html lang="en">
	<head>
		...
		<title>编辑树形实体测试 - Powered By APP TEAM</title>
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<form id="inputForm" action="update.jhtml" class="form-horizontal" role="form" method="post"  >
							<!-- 实体ID隐藏域 -->
							<input type="hidden" name="id" value="${treeEntityTest.id}" />
							<div class="row">
								<div class="col-xs-12">
									<div class="tabbable">
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<select id="parentId" name="parentId" class="col-xs-10 col-sm-5" >
																...
																[#list treeEntityTestTree as treeEntityTestTmp ]
																	[#if treeEntityTestTmp != treeEntityTest && !children?seq_contains(treeEntityTestTmp)]
																	<option value="${treeEntityTestTmp.id}" [#if treeEntityTestTmp == treeEntityTest.parent ]selected="selected"[/#if]>
																		[#if treeEntityTestTmp.grade != 0]
																			[#list 1..treeEntityTestTmp.grade as i]
																				&nbsp;&nbsp;
																			[/#list]
																		[/#if]
																		${treeEntityTestTmp.name}
																	</option>
																	[/#if]
																[/#list]
															</select>
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input type="text" id="order" name="order" value="${(treeEntityTest.order)!}" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="name" value="${(treeEntityTest.name)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="description" value="${(treeEntityTest.description)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
			...
			$inputForm.validate({
				rules: {
					name: {
						required: true,
						remote: {
							url: "check_name_unique.jhtml?previousName=${treeEntityTest.name?url}",
							cache: false
						},
					},
					description: {
