...
<html lang="en">
	<head>
		...
		<title>编辑统计项数据 - Powered By APP TEAM</title>
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<form id="inputForm" action="update.jhtml" class="form-horizontal" role="form" method="post"  >
							<!-- 实体ID隐藏域 -->
							<input type="hidden" name="id" value="${statsData.id}" />
							<div class="row">
								<div class="col-xs-12">
									<div class="tabbable">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															...
															&nbsp;&nbsp;
															<label class="selectedLabel control-label" [#if !(statsData.statsItem??) ]style="display:none;"[/#if] >
																<span class="red" >当前选择：</span>
																<span class="value" >${(statsData.statsItem.title)!}</span>
															</label>
															&nbsp;&nbsp;
															<input type="hidden" style="width:50px!important;" id="statsItemId" name="statsItemId" value="${(statsData.statsItem.id)!}" title="请填写关联实体的 【ID】属性" class="col-xs-5 col-sm-2" />
															<a href="javascript:void(0);" style="width:50px!important; [#if !(statsData.statsItem??) ]display:none;[/#if]" class="clearInputs btn btn-info btn-xs" >清空</a>
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="dataTime" value="${(statsData.dataTime)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="numberValue" value="${(statsData.numberValue)!'0'}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="textValue" value="${(statsData.textValue)!'默认'}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="statsCount">
														<span class="text-danger">*</span>
														<span>统计数据量</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="statsCount" value="${(statsData.statsCount)!'1'}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
