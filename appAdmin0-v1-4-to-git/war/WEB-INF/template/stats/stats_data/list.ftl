...
<html lang="en">
	<head>
		...
		<title>统计项数据列表 - Powered By APP TEAM</title>
								...
								<div class="btn-group btn-corner pull-right">
									<div class="btn-group">
									    ...
									    <ul id="searchPropertyOption" class="dropdown-menu dropdown-info">
											<li [#if page.searchProperty == "textValue" ] class="active" [/#if] val="textValue" >
												<a href="javascript:;" >文本值</a>
											</li>
									    </ul>
									</div>
									...
									<table id="listTable" class="list table table-bordered table-hover">
										<thead>
											<tr>
												...
												<th>
													<a href="javascript:;" class="sort" name="statsItem">
														统计项
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
												<th>
													<a href="javascript:;" class="sort" name="dataTime">
														数据时间
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
												<th>
													<a href="javascript:;" class="sort" name="numberValue">
														数字值
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
												<th>
													<a href="javascript:;" class="sort" name="textValue">
														文本值
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
												<th>
													<a href="javascript:;" class="sort" name="statsCount">
														统计数据量
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
										...
										<tbody>
										[#list page.content as statsData ]
											<tr>
												<td class="center">
													<label class="pos-rel">
														<input type="checkbox" name="ids" class="ace" value="${statsData.id}" />
														<span class="lbl"></span>
													</label>
												</td>
												<td>	
													<span name="statsItem">${(statsData.statsItem.title)!}</span>
												</td>
												<td>				
													<span name="dataTime">${(statsData.dataTime)!}</span>
												</td>
												<td>				
													<span name="numberValue">${(statsData.numberValue)!}</span>
												</td>
												<td>				
													<span name="textValue">${(statsData.textValue)!}</span>
												</td>
												<td>				
													<span name="statsCount">${(statsData.statsCount)!}</span>
												</td>
												<td>
													<!-- 大型ui -->
													<div class="hidden-sm hidden-xs btn-group">
														<a class="btn btn-xs btn-info" href="edit.jhtml?id=${statsData.id}" >
															<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
															<span>${message("admin.common.edit")}</span>
														</a>
														<a href="javascript:void(0);" class="deleteButton btn btn-xs btn-danger" ids="${statsData.id}" >
													...
													<div class="hidden-md hidden-lg">
														<div class="inline pos-rel">
															...
															<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																<li>
																	<a href="edit.jhtml?id=${statsData.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
																		<span class="blue">
																			<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
																			<span>${message("admin.common.edit")}</span>
																		</span>
																...
																<li>
																	<a href="javascript:void(0);" class="deleteButton tooltip-error" ids="${statsData.id}" data-rel="tooltip" title="Delete">
																		<span class="red">
																			<i class="ace-icon fa fa-trash-o bigger-120"></i>
																			<span>${message("admin.common.delete")}</span>
																		</span>
