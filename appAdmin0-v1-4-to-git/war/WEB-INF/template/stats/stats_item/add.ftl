...
<html lang="en">
	<head>
		...
		<title>添加统计项目 - Powered By APP TEAM</title>
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="showTitle" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<select name="statsValueType" class="col-xs-10 col-sm-5" >
																...
																<option value="${statsValueType}" >${(statsValueType.label)!'-'}</option>
																[/#list]
															</select>
														</div>
													</div>
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<select name="statsCycle" class="col-xs-10 col-sm-5" >
																...
																<option value="${statsCycle}" >${(statsCycle.label)!'-'}</option>
																[/#list]
															</select>
														</div>
													</div>
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<select name="statsMethod" class="col-xs-10 col-sm-5" >
																...
																<option value="${statsMethod}" >${(statsMethod.label)!'-'}</option>
																[/#list]
															</select>
														</div>
													</div>
