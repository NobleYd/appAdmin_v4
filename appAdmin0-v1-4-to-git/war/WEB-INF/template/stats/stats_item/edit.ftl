...
<html lang="en">
	<head>
		...
		<title>编辑统计项目 - Powered By APP TEAM</title>
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="title" value="${(statsItem.title)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="showTitle">
														<span class="text-danger">*</span>
														<span>显示标题</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="showTitle" value="${(statsItem.showTitle)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="statsValueType">
														<span class="text-danger">*</span>
														<span>统计值类型</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<select name="statsValueType" class="col-xs-10 col-sm-5" >
																[#list statsValueTypes as statsValueType]
																<option value="${statsValueType}" [#if (statsItem.statsValueType)! == statsValueType]selected="selected"[/#if] >${(statsValueType.label)!'-'}</option>
																[/#list]
															</select>
														</div>
													</div>
												...
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="statsCycle">
														<span class="text-danger">*</span>
														<span>统计周期</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<select name="statsCycle" class="col-xs-10 col-sm-5" >
																[#list statsCycles as statsCycle]
																<option value="${statsCycle}" [#if (statsItem.statsCycle)! == statsCycle]selected="selected"[/#if] >${(statsCycle.label)!'-'}</option>
																[/#list]
															</select>
														</div>
													</div>
												...
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="statsMethod">
														<span class="text-danger">*</span>
														<span>统计方法</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<select name="statsMethod" class="col-xs-10 col-sm-5" >
																[#list statsMethods as statsMethod]
																<option value="${statsMethod}" [#if (statsItem.statsMethod)! == statsMethod]selected="selected"[/#if] >${(statsMethod.label)!'-'}</option>
																[/#list]
															</select>
														</div>
													</div>
