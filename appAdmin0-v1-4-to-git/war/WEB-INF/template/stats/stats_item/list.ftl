...
<html lang="en">
	<head>
		...
		<title>统计项目列表 - Powered By APP TEAM</title>
									...
									<div class="btn-group">
									    ...
									    <ul id="searchPropertyOption" class="dropdown-menu dropdown-info">
											<li [#if page.searchProperty == "title" ] class="active" [/#if] val="title" >
												<a href="javascript:;" >统计项标题(英文)</a>
											</li>
											<li [#if page.searchProperty == "showTitle" ] class="active" [/#if] val="showTitle" >
												<a href="javascript:;" >显示标题</a>
											</li>
									    </ul>
									</div>
									...
									<table id="listTable" class="list table table-bordered table-hover">
										<thead>
											<tr>
												...
												<th>
													<a href="javascript:;" class="sort" name="partnerId">
														创建此统计项的用户ID
												...
												<th>
													<a href="javascript:;" class="sort" name="showTitle">
														显示标题
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
												<th>
													<a href="javascript:;" class="sort" name="statsValueType">
														统计值类型
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
												<th>
													<a href="javascript:;" class="sort" name="statsCycle">
														统计周期
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
												<th>
													<a href="javascript:;" class="sort" name="statsMethod">
														统计方法
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
										...
										<tbody>
										[#list page.content as statsItem ]
											<tr>
												<td class="center">
													<label class="pos-rel">
														<input type="checkbox" name="ids" class="ace" value="${statsItem.id}" />
														<span class="lbl"></span>
													</label>
												</td>
												<td>				
													<span name="partnerId">${(statsItem.partnerId)!}</span>
												</td>
												<td>				
													<span name="title">${(statsItem.title)!}</span>
												</td>
												<td>				
													<span name="showTitle">${(statsItem.showTitle)!}</span>
												</td>
												<td>				
													<span name="statsValueType">${(statsItem.statsValueType)!}</span>
												</td>
												<td>				
													<span name="statsCycle">${(statsItem.statsCycle)!}</span>
												</td>
												<td>				
													<span name="statsMethod">${(statsItem.statsMethod)!}</span>
												</td>
												<td>
													<!-- 大型ui -->
													<div class="hidden-sm hidden-xs btn-group">
														<a class="btn btn-xs btn-info" href="edit.jhtml?id=${statsItem.id}" >
															<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
															<span>${message("admin.common.edit")}</span>
														</a>
														<a href="javascript:void(0);" class="deleteButton btn btn-xs btn-danger" ids="${statsItem.id}" >
															<i class="ace-icon fa fa-trash-o bigger-120"></i>
															<span>${message("admin.common.delete")}</span>
														</a>
														<a class="btn btn-xs btn-success" href="chart/${statsItem.id}.jhtml" >
															<i class="ace-icon fa fa-trash-o bigger-120"></i>
															<span>图表查看</span>
														</a>
													</div>
													...
													<div class="hidden-md hidden-lg">
														<div class="inline pos-rel">
															...
															<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																<li>
																	<a href="edit.jhtml?id=${statsItem.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
																		<span class="blue">
																			<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
																			<span>${message("admin.common.edit")}</span>
																		</span>
																...
																<li>
																	<a href="javascript:void(0);" class="deleteButton tooltip-error" ids="${statsItem.id}" data-rel="tooltip" title="Delete">
																		<span class="red">
																			<i class="ace-icon fa fa-trash-o bigger-120"></i>
																			<span>${message("admin.common.delete")}</span>
																		</span>
