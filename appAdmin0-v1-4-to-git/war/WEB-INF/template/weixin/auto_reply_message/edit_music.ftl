								...
								<div class="col-xs-12">
									<div class="tabbable">
									    <ul class="nav nav-tabs padding-12 tab-color-blue background-blue">
									        <li class="active">
									            <a aria-expanded="true" data-toggle="tab" href="#base">音乐消息</a>
									        </li>
									    </ul>
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="title" value="${(autoReplyMessage.title)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="description" value="${(autoReplyMessage.description)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="musicUrl">
														<span>音乐链接</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="musicUrl" value="${(autoReplyMessage.musicUrl)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="hqMusicUrl">
														<span>高质量音乐链接</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="hqMusicUrl" value="${(autoReplyMessage.hqMusicUrl)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="thumbMediaId">
														<span>缩略图媒体ID</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="thumbMediaId" value="${(autoReplyMessage.thumbMediaId)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
