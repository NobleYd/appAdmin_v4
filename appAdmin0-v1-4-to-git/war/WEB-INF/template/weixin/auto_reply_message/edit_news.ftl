									...
									<div class="tabbable">
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												[#list autoReplyMessage.articles as article]
												<div class="news_item articles${article_index}">
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="title">
															...
															[/#if]
															<span>标题${article_index +1}</span>:
														</label>
														<div class="col-sm-9">
															<div class="clearfix">
																<input name="articles[${article_index}].title" value="${(article.title)!}" type="text" class="col-xs-10 col-sm-5" />
															</div>
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="description">
															<span>描述${article_index +1}</span>:
														</label>
														<div class="col-sm-9">
															<div class="clearfix">
																<input name="articles[${article_index}].description" value="${(article.description)!}" type="text" class="col-xs-10 col-sm-5" />
															</div>
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="picUrl">
															<span>图片链接${article_index +1}</span>:
														</label>
														<div class="col-sm-9">
															<div class="clearfix">
																<input name="articles[${article_index}].picUrl" value="${(article.picUrl)!}" type="text" class="col-xs-10 col-sm-5" />
															</div>
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="url">
															<span>点击后跳转链接${article_index +1}</span>:
														</label>
														<div class="col-sm-9">
															<div class="clearfix">
																<input name="articles[${article_index}].url" value="${(article.url)!}" type="text" class="col-xs-10 col-sm-5" />
															</div>
														</div>
													</div>
												</div>	
												[/#list]
												[#list autoReplyMessage.articleCount+1 .. 10 as count]
												<div class="news_item articles${count-1} hidden">
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="title">
															<input type="button" class="deleteItem btn btn-info btn-xs" value="删除此项" />
															<span>标题${count}</span>:
														...
														<div class="col-sm-9">
															<div class="clearfix">
																<input name="articles[${count-1}].title" type="text" class="col-xs-10 col-sm-5" />
															</div>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-sm-9">
															<div class="clearfix">
																<input name="articles[${count-1}].description" type="text" class="col-xs-10 col-sm-5" />
															</div>
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="picUrl">
															<span>图片链接${count}</span>:
														</label>
														<div class="col-sm-9">
															<div class="clearfix">
																<input name="articles[${count-1}].picUrl" type="text" class="col-xs-10 col-sm-5" />
															</div>
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="url">
															<span>点击后跳转链接${count}</span>:
														</label>
														<div class="col-sm-9">
															<div class="clearfix">
																<input name="articles[${count-1}].url" type="text" class="col-xs-10 col-sm-5" />
															</div>
														</div>
													</div>
												</div>
