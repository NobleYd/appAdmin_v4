								...
								<div class="col-xs-12">
									<div class="tabbable">
									    <ul class="nav nav-tabs padding-12 tab-color-blue background-blue">
									        <li class="active">
									            <a aria-expanded="true" data-toggle="tab" href="#base">视频消息</a>
									        </li>
									    </ul>
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="mediaId">
														<span class="text-danger">*</span>
														<span>视频媒体文件ID</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="mediaId" value="${(autoReplyMessage.mediaId)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
