...
<html lang="en">
	<head>
		...
		<title>编辑素材 - Powered By APP TEAM</title>
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="name" value="${(material.name)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="materialType">
														<span class="text-danger">*</span>
														<span>类型</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<select name="materialType" class="col-xs-10 col-sm-5" >
																[#list MaterialTypes as MaterialType]
																<option value="${MaterialType}" [#if (material.materialType)! == MaterialType]selected="selected"[/#if] >${(MaterialType.label)!'-'}</option>
																[/#list]
															</select>	
														</div>
													</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="media_id" value="${(material.media_id)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="mediaFile">
														<span>媒体文件</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix col-xs-10 col-sm-5">
															<input id="mediaFile" name="mediaFile" type="file" class="" >
														</div>
														<a href="${(material.media)!}" class="btn btn-info btn-xs" target="_blank">${message("admin.common.view")}</a>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="url" value="${(material.url)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
