...
<html lang="en">
	<head>
		...
		<title>素材列表 - Powered By APP TEAM</title>
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			[#assign menu="weixinGroup" subMenu="material" ]
							...
							<input type="submit" name="default" class="hidden" />
								...
								<div class="btn-group">
								    <a aria-expanded="false" data-toggle="dropdown" class="btn btn-info btn-sm dropdown-toggle">
								        ...
								        <span>${message("admin.common.add")}临时素材</span>
								        <i class="ace-icon fa fa-angle-down icon-on-right"></i>
								    </a>
								    <ul class="dropdown-menu dropdown-info">
										<li>
											<a href="add.jhtml?type=temporary&materialType=image">图片素材</a>
										</li>
										<li>
											<a href="add.jhtml?type=temporary&materialType=voice">语音素材</a>
										</li>
										<li>
											<a href="add.jhtml?type=temporary&materialType=video">视频素材</a>
										</li>
										<li>
											<a href="add.jhtml?type=temporary&materialType=thumb">缩略图素材</a>
										</li>
								    </ul>
								</div>
								...
								<div class="btn-group">
								    <a aria-expanded="false" data-toggle="dropdown" class="btn btn-info btn-sm dropdown-toggle">
								        <i class="glyphicon glyphicon-plus"></i>
								        <span>${message("admin.common.add")}永久素材</span>
								        <i class="ace-icon fa fa-angle-down icon-on-right"></i>
								    </a>
								    <ul class="dropdown-menu dropdown-info">
										<li>
											<a href="add.jhtml?type=permanent&materialType=image">图片素材</a>
										</li>
										<li>
											<a href="add.jhtml?type=permanent&materialType=voice">语音素材</a>
										</li>
										<li>
											<a href="add.jhtml?type=permanent&materialType=video">视频素材</a>
										</li>
										<li>
											<a href="add.jhtml?type=permanent&materialType=thumb">缩略图素材</a>
										</li>
								    </ul>
								</div>
									...
									<div class="btn-group">
									    ...
									    <ul id="searchPropertyOption" class="dropdown-menu dropdown-info">
											...
											<li [#if page.searchProperty == "name" ] class="active" [/#if] val="name" >
												<a href="javascript:;" >标题/备注</a>
											</li>
											<!-- 根据N-1类型的titleAttribute搜索 -->
											<!-- 根据N-1类型的titleAttribute搜索 -->
											<li [#if page.searchProperty == "media_id" ] class="active" [/#if] val="media_id" >
												<a href="javascript:;" >媒体ID</a>
											</li>
											<!-- 根据N-1类型的titleAttribute搜索 -->
											<!-- 根据N-1类型的titleAttribute搜索 -->
											<li [#if page.searchProperty == "url" ] class="active" [/#if] val="url" >
									...
									<table id="listTable" class="list table table-bordered table-hover">
										<thead>
											<tr>
												...
												<th>
													<a href="javascript:;" class="sort" name="materialType">
														类型
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
												<th>
													<a href="javascript:;" class="sort" name="media_id">
														媒体ID
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
												<th>
													<span name="media">媒体文件</span>
												</th>
												<th>
													<a href="javascript:;" class="sort" name="url">
														网址
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
										...
										<tbody>
										[#list page.content as material ]
											<tr>
												<td class="center">
													<label class="pos-rel">
														<input type="checkbox" name="ids" class="ace" value="${material.id}" />
														<span class="lbl"></span>
													</label>
												</td>
												<td>				
													<span name="name">${(material.name)!}</span>
												</td>
												<td>
													<span name="materialType">${(material.materialType.label)!}</span>
													[${(material.type.label)!}]
												</td>
												<td>				
													<span name="media_id">${(material.media_id)!}</span>
												</td>
												<td>
													<a title="media" href="${(material.media)!}" target="_blank" >查看/下载</a>	
												</td>
												<td>				
													<span name="url">
														[#if material.url?? ]
															<a title="image url" href="${(material.url)!}" target="_blank" >查看/下载</a>
														[/#if]
													</span>
												</td>
												<td>
													...
													<div class="hidden-sm hidden-xs btn-group">
														<a class="btn btn-xs btn-info" href="edit.jhtml?id=${material.id}" >
															<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
															<span>${message("admin.common.edit")}</span>
														</a>
														<a href="javascript:void(0);" class="deleteButton btn btn-xs btn-danger" ids="${material.id}" >
													...
													<div class="hidden-md hidden-lg">
														<div class="inline pos-rel">
															...
															<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																<li>
																	<a href="edit.jhtml?id=${material.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
																		<span class="blue">
																			<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
																			<span>${message("admin.common.edit")}</span>
																		</span>
																...
																<li>
																	<a href="javascript:void(0);" class="deleteButton tooltip-error" ids="${material.id}" data-rel="tooltip" title="Delete">
																		<span class="red">
																			<i class="ace-icon fa fa-trash-o bigger-120"></i>
																			<span>${message("admin.common.delete")}</span>
																		</span>
