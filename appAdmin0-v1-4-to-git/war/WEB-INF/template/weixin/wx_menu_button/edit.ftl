...
<html lang="en">
	<head>
		...
		<title>编辑微信按钮 - Powered By APP TEAM</title>
	...
	<body class="no-skin">
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<form id="inputForm" action="update.jhtml" class="form-horizontal" role="form" method="post"  >
							<!-- 实体ID隐藏域 -->
							<input type="hidden" name="id" value="${wxMenuButton.id}" />
							<div class="row">
								<div class="col-xs-12">
									<div class="tabbable">
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="name" value="${(wxMenuButton.name)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<select id="wxMenuButtonTypeSelect" name="type" class="col-xs-10 col-sm-5" >
																[#list Types as Type]
																<option value="${Type}" [#if (wxMenuButton.type)! == Type]selected="selected"[/#if] >${(Type.label)!'-'}</option>
																[/#list]
															</select>	
														</div>
													</div>
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<select name="parentId" class="col-xs-10 col-sm-5" >
																...
																<option value="${Parent.id}" [#if (wxMenuButton.parent.id)! == Parent.id ]selected="selected"[/#if] >${(Parent.name)!'-'}</option>
																[/#list]
															</select>
														</div>
													</div>
												...
												<div class="form-group optionalAttr clickAttrs scancode_pushAttrs scancode_waitmsgAttrs pic_sysphotoAttrs pic_photo_or_albumAttrs pic_weixinAttrs location_selectAttrs">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="key" value="${(wxMenuButton.key)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group optionalAttr viewAttrs">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="url" value="${(wxMenuButton.url)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group optionalAttr media_idAttrs view_limitedAttrs">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="media_id" value="${(wxMenuButton.media_id)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
		...
		$().ready(function() {
			...
			//编辑页面的回显
			$optionAttrs.hide();//默认是父按钮，说明都不显示。
			$(".optionalAttr." + $wxMenuButtonTypeSelect.val() + "Attrs").show();
