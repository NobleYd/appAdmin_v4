...
<html lang="en">
	<head>
		...
		<title>微信按钮列表 - Powered By APP TEAM</title>
					...
					<div class="page-content">
						...
						<form id="listForm" action="list.jhtml" method="get">
							...
							<div class="page-header">
								...
								<a href="show_menus.jhtml" class="btn btn-info btn-sm">
									<i class="fa fa-eye"></i>
									<span>查询当前微信按钮方案</span>
								</a>
								
								<a href="set_menus.jhtml" class="btn btn-info btn-xs">
									...
									<div class="btn-group">
									    ...
									    <ul id="searchPropertyOption" class="dropdown-menu dropdown-info">
											<li [#if page.searchProperty == "name" ] class="active" [/#if] val="name" >
												<a href="javascript:;" >显示名称</a>
											</li>
											<li [#if page.searchProperty == "parent.name" ] class="active" [/#if] val="parent.name" >
												<a href="javascript:;" >父按钮</a>
											</li>
											<li [#if page.searchProperty == "key" ] class="active" [/#if] val="key" >
									...
									<table id="listTable" class="list table table-bordered table-hover">
										<thead>
											<tr>
												...
												<th>
													<a href="javascript:;" class="sort" name="type">
														按钮类型
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
												<th>
													<a href="javascript:;" class="sort" name="parent">
														父按钮
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
												<th>
													<a href="javascript:;" class="sort" name="key">
														KEY
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
										...
										<tbody>
										[#list page.content as wxMenuButton ]
											<tr>
												<td class="center">
													<label class="pos-rel">
														<input type="checkbox" name="ids" class="ace" value="${wxMenuButton.id}" />
														<span class="lbl"></span>
													</label>
												</td>
												<td>				
													<span name="name">${(wxMenuButton.name)!}</span>
												</td>
												<td>
													<span name="type">${(wxMenuButton.type.label)!}</span>
												</td>
												<td>	
													<span name="parent">${(wxMenuButton.parent.name)!}</span>
												</td>
												<td>				
													<span name="key">${(wxMenuButton.key)!}</span>
												</td>
												<td>				
													<span name="url">${(wxMenuButton.url)!}</span>
												</td>
												<td>				
													<span name="media_id">${(wxMenuButton.media_id)!}</span>
												</td>
												<td>
													<!-- 大型ui -->
													<div class="hidden-sm hidden-xs btn-group">
														<a class="btn btn-xs btn-info" href="edit.jhtml?id=${wxMenuButton.id}" >
															<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
															<span>${message("admin.common.edit")}</span>
														</a>
														<a href="javascript:void(0);" class="deleteButton btn btn-xs btn-danger" ids="${wxMenuButton.id}" >
													...
													<div class="hidden-md hidden-lg">
														<div class="inline pos-rel">
															...
															<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																<li>
																	<a href="edit.jhtml?id=${wxMenuButton.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
																		<span class="blue">
																			<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
																			<span>${message("admin.common.edit")}</span>
																		</span>
																...
																<li>
																	<a href="javascript:void(0);" class="deleteButton tooltip-error" ids="${wxMenuButton.id}" data-rel="tooltip" title="Delete">
																		<span class="red">
																			<i class="ace-icon fa fa-trash-o bigger-120"></i>
																			<span>${message("admin.common.delete")}</span>
																		</span>
