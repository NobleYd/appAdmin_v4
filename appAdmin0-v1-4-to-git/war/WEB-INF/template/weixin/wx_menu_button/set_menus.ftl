...
<html lang="en">
	<head>
		...
		<title>设置新的微信按钮方案 - Powered By APP TEAM</title>
			...
			<div class="main-content">
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<!-- 表单开始 -->
						<form id="inputForm" action="set_menus.jhtml" class="form-horizontal" role="form" method="post"  >
							<div class="row">
								<div class="col-xs-12">
									<div class="tabbable">
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="ids1">
														<span>按钮1</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<select id="ids1" name="ids" class="col-xs-10 col-sm-5" >
																<option value="" >无</option>
																[#list wxMenuButtons as wxMenuButton ]
																<option value="${wxMenuButton.id}" >${(wxMenuButton.name)!'-'}</option>
																[/#list]
															</select>
														</div>
													</div>
												...
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="ids2">
														<span>按钮2</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<select id="ids2" name="ids" class="col-xs-10 col-sm-5" >
																<option value="" >无</option>
																[#list wxMenuButtons as wxMenuButton ]
																<option value="${wxMenuButton.id}" >${(wxMenuButton.name)!'-'}</option>
																[/#list]
												...
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="ids3">
														<span>按钮3</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<select id="ids3" name="ids" class="col-xs-10 col-sm-5" >
																<option value="" >无</option>
																[#list wxMenuButtons as wxMenuButton ]
																<option value="${wxMenuButton.id}" >${(wxMenuButton.name)!'-'}</option>
																[/#list]
