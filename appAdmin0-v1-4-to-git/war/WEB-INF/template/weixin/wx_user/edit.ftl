...
<html lang="en">
	<head>
		...
		<title>编辑微信用户 - Powered By APP TEAM</title>
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<form id="inputForm" action="update.jhtml" class="form-horizontal" role="form" method="post"  >
							<!-- 实体ID隐藏域 -->
							<input type="hidden" name="id" value="${wxUser.id}" />
							<div class="row">
								<div class="col-xs-12">
									<div class="tabbable">
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="remark" value="${(wxUser.remark)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="wxUserGroupId">
														<span>用户分组</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<select name="wxUserGroupId" class="col-xs-10 col-sm-5" >
																[#list wxUserGroups as wxUserGroup]
																<option value="${wxUserGroup.id}" >${(wxUserGroup.name)!'-'}</option>
																[/#list]
															</select>
														</div>
													</div>
