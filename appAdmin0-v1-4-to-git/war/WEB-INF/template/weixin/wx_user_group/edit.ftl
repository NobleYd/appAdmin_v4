...
<html lang="en">
	<head>
		...
		<title>编辑微信用户分组 - Powered By APP TEAM</title>
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<form id="inputForm" action="update.jhtml" class="form-horizontal" role="form" method="post"  >
							<!-- 实体ID隐藏域 -->
							<input type="hidden" name="id" value="${wxUserGroup.id}" />
							<div class="row">
								<div class="col-xs-12">
									<div class="tabbable">
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="name" value="${(wxUserGroup.name)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
			...
			$inputForm.validate({
				rules: {
					name: {
						required: true,
						remote: {
							url: "check_name_unique.jhtml?previousName=${wxUserGroup.name?url}",
							cache: false
						},
					},
				},
