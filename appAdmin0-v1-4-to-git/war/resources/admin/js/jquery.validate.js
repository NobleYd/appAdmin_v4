...
/**
 * 说明，原先是 assets/js/jquery.validate.js + assets/js/additional-methods.js
 * 但是这样缺少了本文件中几个方法，比如decimal方法，会造成一些错误和影响。
 * 经过最终决定，页面以后只使用此文件。此文件相当于 assets/js/jquery.validate.js + 扩展部分，至于additional-methods.js中的扩展则移动到了本文件下边，即为此段注释之后的代码。
 * 此外，由于additional-methods.js中有了extension，所以上边的extension被注释掉了。
 * */
